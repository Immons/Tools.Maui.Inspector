...
<p align="center">
  ...
  <a href="https://www.nuget.org/packages/Immons.Tools.Maui.Inspector.Sync"><img src="https://img.shields.io/nuget/v/Immons.Tools.Maui.Inspector.Sync.svg?label=Immons.Tools.Maui.Inspector.Sync" alt="Sync tool"/></a>
...
- **Edit the structure, WYSIWYG-style** — drag controls from a toolbox onto the live mirror, add / remove / reorder / reparent / wrap / unwrap / copy-paste elements with undo & redo, and it all lands in your `.xaml` files as real markup ([details](https://github.com/Immons/Tools.Maui.Inspector/wiki/WYSIWYG-editor)).
...
- **Find leaks** — a Memory view with live readings, leak snapshots (which pages, views and view models outlived their window, with the MAUI-specific evidence) and one-click heap dumps through `dotnet-gcdump`, root paths included ([details](https://github.com/Immons/Tools.Maui.Inspector/wiki/Memory-and-leaks)).
- **Design like in a designer** — snap lines, alignment pins, a drag-to-resize grid designer, style extraction, an editable resources browser, a live XAML preview of the selection — and a **design cookbook**: the app's colors, fonts, styles, controls, images and templates as live samples, with a before/after diff of what a style edit changed ([details](https://github.com/Immons/Tools.Maui.Inspector/wiki/Styles-and-resources#the-design-cookbook)).
...
extensions) are listed in [Getting started](https://github.com/Immons/Tools.Maui.Inspector/wiki/Getting-started#packages).

![Web panel](https://raw.githubusercontent.com/Immons/Tools.Maui.Inspector/main/docs/web-inspector.png)

## Documentation

The full guide is in the [wiki](https://github.com/Immons/Tools.Maui.Inspector/wiki).

| Page | What is in it |
| --- | --- |
| [Getting started](https://github.com/Immons/Tools.Maui.Inspector/wiki/Getting-started) | Packages, the two-line setup, options, manual control |
| [The web panel](https://github.com/Immons/Tools.Maui.Inspector/wiki/Web-panel) | The panel's views and toolbars, and the on-device overlay |
| [Inspecting](https://github.com/Immons/Tools.Maui.Inspector/wiki/Inspecting) | The tree, the box model, the property sheet, live edits |
| [Styles & resources](https://github.com/Immons/Tools.Maui.Inspector/wiki/Styles-and-resources) | Extract style, the editable Resources popup, the design cookbook |
| [WYSIWYG editor](https://github.com/Immons/Tools.Maui.Inspector/wiki/WYSIWYG-editor) | Structure editing, the toolbox, snap lines and the grid designer |
| [Sync tool](https://github.com/Immons/Tools.Maui.Inspector/wiki/Sync-tool) | `maui-inspector-sync`: XAML write-back, heap dumps, device port forwarding |
| [Network & HTTP mocking](https://github.com/Immons/Tools.Maui.Inspector/wiki/Network-and-mocking) | Recording, mock rules, scenarios, breakpoints, offline replay |
| [Memory & leaks](https://github.com/Immons/Tools.Maui.Inspector/wiki/Memory-and-leaks) | Live readings, leak snapshots, heap dumps with root paths |
| [Multi-device](https://github.com/Immons/Tools.Maui.Inspector/wiki/Multi-device) | One panel driving several simulators, emulators and phones |
| [UI tests](https://github.com/Immons/Tools.Maui.Inspector/wiki/UI-tests) | Maestro and Appium: AutomationIds, mocks and a leak gate |
| [HTTP API](https://github.com/Immons/Tools.Maui.Inspector/wiki/HTTP-API) | Every endpoint the panel itself uses |
| [Reference](https://github.com/Immons/Tools.Maui.Inspector/wiki/Reference) | Platforms, options, storage, how it works, troubleshooting, limitations |
