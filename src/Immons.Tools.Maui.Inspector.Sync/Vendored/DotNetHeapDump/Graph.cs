// Vendored from dotnet/diagnostics (src/Tools/dotnet-gcdump/DotNetHeapDump), MIT — see README.md. Unmodified except for these two pragmas.
#nullable disable
...
public class SpanningTree
{
    ...
    public void ForEach(Action<NodeIndex> callback)
    {
        ...
        for (int i = 0; ; i++)
        {
            ...
            nodeIndex = nodesToVisit.Dequeue(out float nodePriority);
